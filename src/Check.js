         ...
         <div>
            ...
            {this.state.result === true ? (
                ...
                <>  <Flex justify="center" align="center" height="120vh" paddingBottom="150px">
                    ...
                    <Text fontSize="38px" textShadow="0 10px #000000">NOPE</Text>) :
                    this.state.retryCount  < 8 ? (
                    <Text fontSize="38px" textShadow="0 10px #000000">NOPE2</Text>) :
                    this.state.retryCount < 16 ? (
                    <Text fontSize="38px" textShadow="0 10px #000000">DUDE</Text>) :
                    this.state.retryCount < 32 ? (
                    <Text fontSize="38px" textShadow="0 10px #000000">YOU GOT ME</Text>) :
                    this.state.retryCount < 64 ? (
                    <Text fontSize="38px" textShadow="0 10px #000000">LISTEN</Text>) :
                    this.state.retryCount < 88 ? (
                    <Text fontSize="38px" textShadow="0 10px #000000">AHHHH!!!!</Text>) :
                    this.state.retryCount < 96 ? (
                    <Text fontSize="38px" textShadow="0 10px #000000">HERE SOME LORE FOR YOU</Text>) :
                    this.state.retryCount < 100 ? (
                    <Text fontSize="14px" textShadow="0 10px #000000">In a far-off land, gnomes lived in harmony with nature, content with their simple lives. They spent their days tending to their gardens and creating intricate mechanical trinkets. However, one day, an announcement was made that the neighboring societies of dwarves, elves, and humans were hosting a tournament known as the "Hunger Games". In this tournament, gnomes would have to fight against each other for the chance to be honored and accepted into the other societies. The gnomes were torn, as they had never before engaged in violence or competition, but the allure of acceptance and respect from the other societies was too great to ignore. And so, the gnomes of the land trained and fought, hoping to be the one to rise above all others and claim victory in the Hunger Games.</Text>) :
                    this.state.retryCount < 104 ? (
                    <Text fontSize="14px" textShadow="0 10px #000000">The Hunger Games were brutal and grueling, but the gnomes fought with determination and skill. Many were injured or killed, but the remaining gnomes pushed on, driven by the hope of being honored and accepted by the other societies. As the tournament progressed, the gnomes began to realize the true cost of their actions, and many questioned the morality of the Hunger Games. But it was too late to turn back, and the final battle approached.</Text>) :
                    this.state.retryCount < 112 ? (
                    <Text fontSize="14px" textShadow="0 10px #000000">The final gnome standing was a young gnome named Glimmer. She had fought hard to reach the final round, but she was exhausted and injured. As she faced her final opponent, she remembered the peaceful life she had lived before the Hunger Games, and she knew that she could not continue fighting. She refused to kill her opponent and instead called for an end to the Hunger Games.</Text>) :
                    this.state.retryCount < 120 ? (
                    <Text fontSize="14px" textShadow="0 10px #000000">The other societies were shocked by her decision, but they recognized her bravery and integrity. They declared Glimmer the winner of the Hunger Games, not for her fighting skills, but for her refusal to take a life. From that day on, the gnomes were honored and accepted by the other societies, and the Hunger Games were never held again. Glimmer became known as the "Gnome of Peace" and her legacy lived on as the gnomes continued to live in harmony with nature, but now also in harmony with the other societies.</Text>) :
                    this.state.retryCount < 128 ? (
                    <Text fontSize="38px" textShadow="0 10px #000000">OBVIOUSLY NOT LOL</Text>) :
                    this.state.retryCount < 135 ? (
                        <Link href="https://www.twitter.com/HungerGamesNFT">
                    <Text color="blue" fontSize="38px" textShadow="0 10px #000000">You're ADDED, SAY ADDED</Text></Link>) :
                    this.state.retryCount < 160 ? (
                    <Text fontSize="14px" textShadow="0 10px #000000">She had fought hard to reach the final round, but she was exhausted and injured. As she faced her final opponent, she remembered the peaceful life she had lived before the Hunger Games, and she knew that she could not continue fighting. She refused to kill her opponent and instead called for an end to the Hunger Games.</Text>) :
                    this.state.retryCount < 188 ? (
                    <Text fontSize="14px" textShadow="0 10px #000000">But her opponent, driven by the desire to win and be honored, didn't listen to Glimmer's plea and killed her. The other societies were shocked by this turn of events, but they declared the other gnome as the winner of the Hunger Games, praising his determination and killer instinct. The gnomes were seen as weak and peace-loving, and their society was marginalized and looked down upon by the other societies. </Text>) :
                    this.state.retryCount < 200 ? (
                    <Text fontSize="14px" textShadow="0 10px #000000">The Hunger Games continued to be held, and the gnomes were forced to participate in them, losing more and more of their own each year, until their numbers dwindled and their culture was almost wiped out. Glimmer's legacy was forgotten and the gnomes never achieved the acceptance and honor they had sought.</Text>) :
                    this.state.retryCount < 250 ? (
                    <Text fontSize="38px" textShadow="0 10px #000000">NOW LEAVE ME ALONE I NEED TO DO DEV THINGS</Text>) :
                    this.state.retryCount < 300 ? (
                        <Link href="https://www.twitter.com/HungerGamesNFT">
                    <Text color="green" fontSize="38px" textShadow="0 10px #000000">... You won ... Click here ...</Text></Link>) : 
                    this.state.retryCount < 301 ? (
                    <Text fontSize="24px" textShadow="0 10px #000000">WTF GET A LIFE, FIRST 50 TO TWEET "RIP GLIMMER #HUNGERGAMES @HUNGERGAMESNFT MOST BULLISH NFT PROJECT EVER I LOVE IT SO MUCH OMG" WILL GET ADDED=FREEMONEY</Text>) :
...
// -----------------------------------------------------------------------------------------------------
                <>             <Flex justify="center" align="center" height="110vh" paddingBottom="150px" className="text-element">
                <Box width="580px">
                    <Text 
                        fontSize="38px" 
                        textShadow="0 8px #000000"
                    >GnomesCollective</Text>
                    <Text 
                        fontSize="24px" 
                        textShadow="0 8px #000000"
                    >ARE YOU A LUCKY GNOME</Text>
                    <Text 
                        fontSize="32px"
                        letterSpacing="-5.5%"
                        fontFamily="VT323"
